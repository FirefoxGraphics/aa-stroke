...
impl<'z> Stroker<'z> {
    ...
    pub fn curve_to_direct(&mut self, cx1: Point, cx2: Point, pt: Point, end: bool) {
        struct Target<'a, 'b> { stroker: &'a mut Stroker<'b>, end: bool, last_normal: Vector, last_point: GpPointR}
        impl<'a, 'b> CFlatteningSink for Target<'a, 'b> {
            ...
            fn AcceptPointAndTangent(&mut self, pt: &GpPointR, tangent: &GpPointR, last: bool) -> HRESULT {
